...
public class ExamTestContainer extends TestContainer {

    public ExamTestContainer() {
        super();
    ...
    public static class Common extends ExamTestContainer {

        public static final ExamTestContainer.Common INSTANCE = new ExamTestContainer.Common();
